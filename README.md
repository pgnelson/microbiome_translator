...
This model finds that 25% of the variance of 12,13-diHOME is explained by species composition. 12,13-diHOME is known to be microbially derived and has been linked to inflammation and asthma in infants (Levan et al. 2019). Additionally, hydrocinnamate is known to correlate with gut microbial diversity (Menni et al. 2020) and mandelate is metabolised by a variety of microbes (Want et al. 2022); promising indicators that model is finding real biological signal. <br/>
